...
@Component class DemoAiProvider implements AiProvider { /**
                                                         * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                         */
public AiResult execute(String prompt,Map<String,String> context){return new AiResult("demo-service-provider","已生成带知识依据的演示回复，涉及业务承诺时必须由坐席确认。",Map.of("sentiment","neutral","citations",2,"humanReview",true));} }
